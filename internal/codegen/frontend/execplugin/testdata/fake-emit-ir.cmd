...
echo   ],
echo   "services": [{"go_name": "EchoService", "full_name": "echo.v1.EchoService", "methods": [
echo     {"go_name": "Echo", "full_name": "echo.v1.EchoService.Echo", "input_type": "EchoRequest", "output_type": "EchoResponse", "shape": 0},
echo     {"go_name": "Watch", "full_name": "echo.v1.EchoService.Watch", "input_type": "WatchRequest", "output_type": "Event", "shape": 1, "server_stream": true}
echo   ]}]
echo }
