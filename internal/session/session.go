// Package framing defines Session and Call interfaces for protocol session.
//
...
// Options is an instance-level immutable snapshot passed at assembly time.
...
//
// CodecName and Options are instance-level and already supplied via SessionSpec
...
type Framing interface {
	...
	// On success the Session owns Conn; on failure the caller — the axis that
	// dialed it, not the composition layer — closes Conn.
